		...
		<div className="max-w-4xl mx-auto px-4 py-12 text-gray-800 space-y-10">
			...
			<FadeInWhenVisible>
				<section>
					...
					<p className="mt-4">
						Fashion, jewellery, diamonds and styling were the strongest bonds between Jeevika and her mom. This shared love became the priceless inheritance that shaped Jeevika's creative direction, instilling a deep appreciation for the artistry and emotional connection
						jewellery can foster.
					</p>
					<p className="mt-4">
